module.exports = {
        ...
        postCars: (req,res,next) => {
            ...
            const db = req.app.get('db')
            db.postCars(req.body.usercar_id,req.body.parkingspacetype_id, req.body.make, req.body.model, req.body.licenseplate, req.body.valettag, req.body.color)
                .then(response => {res.status(200).json(response);})
                .catch(  () => res.status(500).send() );
        },
